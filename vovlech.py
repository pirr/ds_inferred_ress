...
file_path = u'D://work//!Прогнозные ресурсы//НовО,КемО,ТомО,ОмО//reestr_4субъекта_Кемерово_20032017.xls'
data = pd.read_excel(file_path, sheetname='Реестр', skiprows=1)
